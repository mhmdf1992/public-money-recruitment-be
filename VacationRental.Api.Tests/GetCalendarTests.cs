    ...
    public class GetCalendarTests
    {
        ...
        public async Task GivenCompleteRequest_WhenGetCalendar_ThenAGetReturnsTheCalculatedCalendar()
        {
            ...
            using (var getCalendarResponse = await _client.GetAsync($"/api/v1/calendar?rentalId={postRentalResult.Id}&start=2000-01-01&nights=5"))
            {
                ...
                Assert.Equal(3, getCalendarResult.Dates.Count);

                Assert.Equal(new DateTime(2000, 01, 02), getCalendarResult.Dates[0].Date);
                ...
                Assert.Equal(new DateTime(2000, 01, 03), getCalendarResult.Dates[1].Date);
                ...
                Assert.Equal(new DateTime(2000, 01, 04), getCalendarResult.Dates[2].Date);
